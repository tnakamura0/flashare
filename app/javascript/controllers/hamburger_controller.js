...
export default class extends Controller {
  static targets = [ "hamburgerLine1", "hamburgerLine2", "hamburgerLine3", "hamburgerMenuMobile", "hamburgerMenu", "overlay" ]
  ...
  switchMenu() {
    ...
    this.hamburgerMenuMobileTarget.classList.toggle("-right-4/5")
    this.hamburgerMenuMobileTarget.classList.toggle("right-0")

    this.hamburgerMenuTarget.classList.toggle("-right-3/10")
